...
public class ProductPriceVerify extends AbstractComponent{
	 ...
	 */
	public ResultSet getProductPriceFromDB(String tableName,int productID) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		...
		ResultSet data = s.executeQuery("Select * from "+tableName+" Where product_id  ='"+productID+"';");		 
		return data;
	}
